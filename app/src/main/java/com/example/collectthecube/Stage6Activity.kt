...
class Stage6Activity : AppCompatActivity() {
    ...
    private fun loadContentFromFirebase() {
        ContentLoader.loadStageContent("stage6",
    ...
    private fun createCenteredImage(section: Map<String, Any>) {
        ...
        // Title (для длинных алгоритмов используем меньший шрифт)
    ...
    private fun updateButtonState(isCompleted: Boolean) {
        markCompletedButton.apply {
            ...
            setBackgroundColor(ContextCompat.getColor(this@Stage6Activity,
